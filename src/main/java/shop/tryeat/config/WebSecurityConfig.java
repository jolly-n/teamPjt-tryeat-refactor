...
import shop.tryeat.domain.member.entity.MemberRole;
import shop.tryeat.domain.member.service.MemberSecurityService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/", "/css/**", "/img/**", "/js/**", "/vendor/**", "/files/**",
                        ...
                        "/items", "/items/{id}", "/items/vendor/**", "/qna", "/notices", "/notices/{noticeId}", "/api/**").permitAll()
