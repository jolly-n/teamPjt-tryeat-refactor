...
import static shop.tryeat.domain.item.entity.QImage.image;
...
import shop.tryeat.domain.item.dto.QItemSearchDto;
import shop.tryeat.domain.item.entity.Category;
import shop.tryeat.domain.item.entity.Image;
import shop.tryeat.domain.item.entity.ImageType;
